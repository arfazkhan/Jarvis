...
Usage:
    ...
    # CLI
    python -m agent_bms.main --mode simulator
"""
...
from agent_bms.bacnet_adapter import BACnetAdapter, BACnetSimulatorAdapter, BACnetPoint
from agent_bms.api.routes import create_api
from agent_bms.tools_schema import BMSToolHandler, get_bms_tools, get_ops_copilot_prompt
...
class OpsCopilot:
    ...
    async def _start_simulator(self) -> None:
        ...
        self._register_zone_configurations()
    ...
    def _register_zone_configurations(self) -> None:
    ...
    async def _simulation_loop(self) -> None:
        ...
        import random
        from agent_bms.bms_data_model import EnergyReading
            ...
            try:
                ...
                for point in points:
                    if "KW" in point.point_id:
                        ...
                        self.database.save_energy_reading(
                            meter_id=point.equipment_id,
                            value=point.value,
                            unit="kW",
                            timestamp=point.timestamp,
    ...
    async def _simulate_random_alarm(self) -> None:
        ...
        from agent_bms.bms_data_model import Alarm, AlarmSeverity
        import random
