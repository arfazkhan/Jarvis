...
export const api = {
  ...
  applyAssetPpm: (id) => api.post(`/assets/${id}/apply-ppm`),
  ...
  adminLlmConfig: () => api.get('/admin/llm/config'),
  adminSetLlmConfig: (body) => api.post('/admin/llm/config', body),
  adminEmbedConfig: () => api.get('/admin/embed/config'),
  adminSetEmbedConfig: (body) => api.post('/admin/embed/config', body),
  adminSttConfig: () => api.get('/admin/stt/config'),
  adminSetSttConfig: (body) => api.post('/admin/stt/config', body),
  adminAddLlmKey: (api_key) => api.post('/admin/llm/keys', { api_key }),
  adminRemoveLlmKey: (last4) => api.del(`/admin/llm/keys/${last4}`),
